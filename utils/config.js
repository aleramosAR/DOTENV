...
export const FACEBOOK_CLIENT_ID = process.env.FACEBOOK_CLIENT_ID || '559885825005670';
export const FACEBOOK_CLIENT_SECRET = process.env.FACEBOOK_CLIENT_SECRET || '6a2926fd1ded556381f2275ddfbee1f2';
